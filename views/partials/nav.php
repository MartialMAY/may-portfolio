    ...
    <div class="container-main flex items-center justify-between">
        ...
        <div class="flex items-center gap-4 md:gap-6">
            <div class="hidden sm:flex items-center gap-4">
                <a href="<?php echo htmlspecialchars($settings['linkedin_url'] ?? 'https://linkedin.com'); ?>" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full border border-gray-100 flex items-center justify-center text-gray-400 hover:text-blue-600 hover:border-blue-600 transition-all duration-300" aria-label="LinkedIn">
                    <i data-feather="linkedin" class="w-4 h-4"></i>
                </a>
                <a href="<?php echo htmlspecialchars($settings['github_url'] ?? 'https://github.com'); ?>" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full border border-gray-100 flex items-center justify-center text-gray-400 hover:text-black hover:border-black transition-all duration-300" aria-label="GitHub">
