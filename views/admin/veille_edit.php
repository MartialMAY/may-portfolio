...
<body class="bg-[#f8f8f8]">
    <nav class="bg-white border-b border-gray-100 px-8 py-4 flex justify-between items-center fixed top-0 w-full z-50">
        ...
        <a href="/testportfolio/admin/veille" class="text-xs font-bold uppercase tracking-widest text-gray-400 hover:text-black">Retour au dashboard</a>
    </nav>
                        ...
                        <div class="space-y-4">
                            ...
                            <?php if (isset($article['image_url'])): ?>
                                <div class="mb-4 h-32 w-48 rounded-xl overflow-hidden border border-gray-100">
                                    <img src="/testportfolio/<?php echo $article['image_url']; ?>" class="w-full h-full object-cover">
                                </div>
                            <?php endif; ?>
