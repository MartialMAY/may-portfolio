            ...
            <?php foreach ($projects as $proj): ?>
                <div class="bg-white border border-gray-100 rounded-[2rem] overflow-hidden shadow-sm group">
                    <div class="h-48 overflow-hidden bg-gray-100">
                        <img src="<?php echo $this->base; ?>/<?php echo $proj['image_url']; ?>" alt="" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                    </div>
                    <div class="p-8">
                        ...
                        <div class="flex gap-4 pt-4 border-t border-gray-50">
                            <a href="<?php echo $this->base; ?>/admin/projects/edit?id=<?php echo $proj['id']; ?>" class="flex-1 flex justify-center p-3 bg-gray-50 rounded-xl hover:bg-black hover:text-white transition-all">
                                <i data-feather="edit-2" class="w-4 h-4"></i>
                            </a>
                            <a href="<?php echo $this->base; ?>/admin/projects/delete?id=<?php echo $proj['id']; ?>" onclick="return confirm('Supprimer ce projet ?')" class="flex-1 flex justify-center p-3 bg-gray-50 rounded-xl hover:bg-red-500 hover:text-white transition-all text-red-500">
